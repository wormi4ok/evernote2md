...
const (
	...
	wantLongName        = ``
	...
	wantMultibyteString = `上村脱史肝感円詰人子意情涯局需日曜予楽雑割応内提健門畔和機読展民安模新越権政評図行部提政賛必能新国統本覧応測属対賀君光間断難察展任下産位断物氷与英良図数訪死変度稲与個高職車察渉沢次読康寧平展申赤購刊皿正大想球米読量減阪誠投乏止圧北馬委日江変紀京墳判賞別側稿沖商終成伝館内御交返交換臓多積社計覚大的豊冷役権校宴要援年善真走橋生閥映氷東毎止育自前動歳線定見保劇寺触室幕作書刺山設経録車応探済本候困求止長年子追年意経燃図楽南未向連横業籠結遇趣挑見健証級代卒料済株迭済変物歌会多意生式童要更事記火卒動職寺誉第康真資板遅政南済記試表戒匿軍入読的池要処情一払注野原謙湖高由題質親報質振炎計界能転火鹿午京授需国供北容期字芝性木完文案合的根間津選減野部校足石正治解木払多歩郵難故`
)
